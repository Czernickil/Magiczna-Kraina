...
public class PytaniePolskiJedenPunktMag extends Activity {    public void onStart(){         super.onStart(); Menu.poprawneWylaczenie =0;}
    TextView odp1;
    TextView odp2;
    TextView odp3;
    TextView odp4;
    ...
    public void dobra(View view) {
        Intent intent = new Intent(PytaniePolskiJedenPunktMag.this, DobrzeMagJedenPunkt.class);
        Menu.poprawneWylaczenie =1; startActivity(intent);
    }
    public void zla(View view) {
        Intent intent = new Intent(PytaniePolskiJedenPunktMag.this, ZlaOdpowiedzMaga.class);
        Menu.poprawneWylaczenie =1; startActivity(intent);
    }
