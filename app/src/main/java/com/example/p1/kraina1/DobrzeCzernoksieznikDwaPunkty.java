...
public class DobrzeCzernoksieznikDwaPunkty extends Activity {
    public void onStart() {
        super.onStart();
    ...
    public void powrot(View view) {
        ...
        setDefaultspc("etatTogglep", punktyCzarnoksieznika + 2, this);
        Intent intent = new Intent(DobrzeCzernoksieznikDwaPunkty.this, com.example.p1.kraina1.GlownyWidokMaga.class);
