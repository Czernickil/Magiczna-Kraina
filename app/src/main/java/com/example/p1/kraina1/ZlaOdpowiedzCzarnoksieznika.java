...
public class ZlaOdpowiedzCzarnoksieznika extends Activity {    public void onStart(){         super.onStart(); Menu.poprawneWylaczenie =0;}
    ...
    public void powrot(View view) {
        Intent intent = new Intent(ZlaOdpowiedzCzarnoksieznika.this, GlownyWidokMaga.class);
