...
public class PytanieABCDMaga extends Activity {
    public void onStart() {
        super.onStart();
    ...
    public void dobra(View view) {
        ...
        if(wartoscPunktowa==1){
             intent = new Intent(PytanieABCDMaga.this, DobrzeMagJedenPunkt.class);}
        else if(wartoscPunktowa==2){
             intent = new Intent(PytanieABCDMaga.this, DobrzeMagDwaPunkty.class);}
        else {
             intent = new Intent(PytanieABCDMaga.this, DobrzeMagTrzyPunkty.class);}
        Menu.poprawneWylaczenie = 1;
        startActivity(intent);
    }

    public void zla(View view) {
        Intent intent = new Intent(PytanieABCDMaga.this, ZlaOdpowiedzMaga.class);
        Menu.poprawneWylaczenie = 1;
        startActivity(intent);
    }
