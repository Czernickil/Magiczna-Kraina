...
public class PytanieZycieTrzyPunktyMag extends Activity {
    public void onStart() {
        super.onStart();
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   while (PytanieTesktowe.getPytpol1(i, 5).equals("Z"))
        ...
        pytanie = repozytoriumPytan.pozyskajPytaniaWedlugKategoriiPunktow("Zycie", 3);
    ...
    public void dobra(View view) {
        Intent intent = new Intent(PytanieZycieTrzyPunktyMag.this, DobrzeMagTrzyPunkty.class);
        Menu.poprawneWylaczenie = 1;
        startActivity(intent);
    }

    public void zla(View view) {
        Intent intent = new Intent(PytanieZycieTrzyPunktyMag.this, ZlaOdpowiedzMaga.class);
        Menu.poprawneWylaczenie = 1;
        startActivity(intent);
    }
