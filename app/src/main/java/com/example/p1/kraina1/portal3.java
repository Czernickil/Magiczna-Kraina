...
import static lukasz.p1.kraina1.Menu.kon; public class portal3 extends AppCompatActivity {    public void onStart(){         super.onStart(); Menu.wyl=0;}
    ...
    public void powrot(View view) {
        ...
        if (r == 1) {
            punkty=punkty+1;
            Intent intent = new Intent(portal3.this, MainActivityc.class);
            Menu.wyl=1; startActivity(intent);
        } else {
            punktyc=punktyc+1;
            Intent intent = new Intent(portal3.this, MainActivity.class);
            Menu.wyl=1; startActivity(intent);
        }
    }
}
