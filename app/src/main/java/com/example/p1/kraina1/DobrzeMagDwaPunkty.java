...
public class DobrzeMagDwaPunkty extends Activity {
    public void onStart() {
        super.onStart();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (s == 1) {
            ...
            textviev.setText("");
            com.example.p1.kraina1.GifSkrzatZeZmianaMag gifView = (com.example.p1.kraina1.GifSkrzatZeZmianaMag) findViewById(R.id.gifz);
    ...
    public void powrot(View view) {
        ...
        setDefaultsp("etatTogglep", punktyMaga + 2, this);
        Intent intent = new Intent(DobrzeMagDwaPunkty.this, GlownyWidokCzarnoksieznika.class);
