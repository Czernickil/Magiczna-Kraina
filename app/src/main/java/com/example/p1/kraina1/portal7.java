...
import static lukasz.p1.kraina1.Menu.kon; public class portal7 extends AppCompatActivity {    public void onStart(){         super.onStart(); Menu.wyl=0;}
    @Override
    ...
    public void powrot(View view) {
        ...
        if (r == 1) {
            punkty=punkty-2;
            Intent intent = new Intent(portal7.this, MainActivityc.class);
            Menu.wyl=1; startActivity(intent);
        } else {
            punktyc=punktyc-2;
            Intent intent = new Intent(portal7.this, MainActivity.class);
            Menu.wyl=1; startActivity(intent);
        }
    }
}
