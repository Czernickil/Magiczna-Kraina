...
public class PytaniePolskiJedenPunktCzarnoksieznik extends Activity {    public void onStart(){         super.onStart(); Menu.poprawneWylaczenie =0;}
    TextView odp1;
    TextView odp2;
    TextView odp3;
    TextView odp4;
    ...
    public void sprawdz1(View view){
        if(PytanieTesktowe.getPytpol1(i, 6).equals(PytanieTesktowe.getPytpol1(i, 1)))
            dobra(view);
        else
            zla(view);
    }
    public void sprawdz2(View view){
        if(PytanieTesktowe.getPytpol1(i, 6).equals(PytanieTesktowe.getPytpol1(i, 2)))
            dobra(view);
        else
            zla(view);
    }
    public void sprawdz3(View view){
        if(PytanieTesktowe.getPytpol1(i, 6).equals(PytanieTesktowe.getPytpol1(i, 3)))
            dobra(view);
        else
            zla(view);
    }
    public void sprawdz4(View view){
        if(PytanieTesktowe.getPytpol1(i, 6).equals(PytanieTesktowe.getPytpol1(i, 4)))
            dobra(view);
        else
            zla(view);
    }
    ...
    public void dobra(View view) {
        Intent intent = new Intent(PytaniePolskiJedenPunktCzarnoksieznik.this, DobrzeCzernoksieznikJedenPunkt.class);
        Menu.poprawneWylaczenie =1; startActivity(intent);
    }
    public void zla(View view) {
        Intent intent = new Intent(PytaniePolskiJedenPunktCzarnoksieznik.this, ZlaOdpowiedzCzarnoksieznika.class);
        Menu.poprawneWylaczenie =1; startActivity(intent);
    }
