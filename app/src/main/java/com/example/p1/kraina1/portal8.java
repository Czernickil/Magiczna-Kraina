...
import static com.example.p1.kraina1.Menu.kon; public class portal8 extends AppCompatActivity {    public void onStart(){         super.onStart(); Menu.wyl=0;}
    ...
    public void powrot(View view) {
        ...
        if (r == 1) {
            punkty=punkty-3;
            Intent intent = new Intent(portal8.this, MainActivityc.class);
            Menu.wyl=1; startActivity(intent);
        } else {
            punktyc=punktyc-3;
            Intent intent = new Intent(portal8.this, MainActivity.class);
            Menu.wyl=1; startActivity(intent);
        }
    }
}
