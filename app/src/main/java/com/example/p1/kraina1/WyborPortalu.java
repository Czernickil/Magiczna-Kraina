...
public class WyborPortalu extends Activity {    public void onStart(){         super.onStart(); Menu.poprawneWylaczenie =0;}
    ...
    public void portall(View view) {
        ...
        switch(i){
            ...
            case 2:
                ...
                Menu.poprawneWylaczenie =1; startActivity(intent);                break;
            case 3:
